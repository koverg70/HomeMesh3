...
static const char *client_method;
...
//
void client_browse_url(const char *urlbuf, char *urlbuf_varpart, const char *hoststr,void (*callback)(uint8_t,uint16_t))
{
...
void client_http_post(const char *urlbuf, const char *hoststr, const char *additionalheaderline, const char *method, char *postval,void (*callback)(uint8_t,uint16_t))
{
        client_urlbuf=urlbuf;
        client_hoststr=hoststr;
